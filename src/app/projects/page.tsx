          ...
          >
            {projects.filter(p => p.featured).map((project, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-muted to-border rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-transparent"
              >
                <motion.div 
                  className="aspect-video flex items-center justify-center bg-background/10"
                ...
                <div className="p-8">
                  ...
                  {project.external ? (
                    <motion.a
                      ...
                      className="inline-flex items-center text-primary hover:underline font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded"
                      whileHover={{ x: 5 }}
                      transition={{ duration: 0.2 }}
                    >
                      Visit Project →
          ...
          >
            {projects.map((project, index) => (
              <motion.div
                ...
                {...cardHover}
                transition={{ delay: index * 0.1 }}
                className="bg-background rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-muted"
              >
                <motion.div 
                  className="aspect-video flex items-center justify-center bg-gradient-to-br from-muted to-border"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.2 }}
                >
                  <div className="text-[#45a8e6] text-center">
                ...
                <div className="p-6">
                  ...
                  <p className="text-foreground mb-4 text-sm text-pretty">
                    {project.description}
                  </p>
                  ...
                  {project.external ? (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-primary hover:underline font-medium text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded"
                      whileHover={{ x: 3 }}
                      transition={{ duration: 0.2 }}
                    >
                      Visit Project →
